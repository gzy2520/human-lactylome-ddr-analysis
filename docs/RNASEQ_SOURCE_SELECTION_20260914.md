...
**后续替代数据已落实**：优先读取[重复数解决报告](../audit/20260915_replicate_resolution/REPORT.md)和[新候选门控表](../config/rnaseq_replicate_resolution_gate_20260915.csv)。10套稳定ID计数矩阵已验收；下文关于HK2文件待验收、肌腱/PC-3M必须重算FASTQ的旧判断已被新证据更新。生物学条件与独立性仍单独审核。
