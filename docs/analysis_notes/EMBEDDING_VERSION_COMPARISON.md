...
- V1：`results/figures/kla_ddr_five_set_three_embedding_pathway_grids_33groups_v1/`
- V2：`results/figures/kla_ddr_five_set_three_embedding_pathway_grids_33groups_v2/`
- V3：`results/figures/five_set_embeddings/`
