...
- 15张九宫格清单：`results/tables/five_set_embeddings/figure_manifest_15_grids.csv`
- 五套调参坐标：`results/tables/five_set_embeddings/embedding_coordinates_5sets_tuned_long.csv`
- 最终参数长表：`results/tables/five_set_embeddings/embedding_parameters_5sets_tuned.csv`
- 逐集合推荐：`results/tables/five_set_embeddings/parameter_tuning_recommendation_by_set.csv`
- 候选参数排名：`results/tables/five_set_embeddings/parameter_tuning_ranked_candidates_by_set.csv`
- 参数筛选原始指标：`results/tables/five_set_embeddings/parameter_tuning_metrics_by_set.csv`
- 输入审计：`results/tables/five_set_embeddings/input_file_audit.csv`
