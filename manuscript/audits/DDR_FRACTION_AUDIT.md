...
- 主图：
  `results/figures/cell_type_kla_vs_reference_ddr_fraction.png`
- 中文主图：
...
- 独立命名图：
  `results/figures/cell_type_kla_vs_reference_ddr_fraction_accession_only.png`
- 37组来源审计统计表：
  `results/tables/cell_type_kla_vs_reference_ddr_statistics_accession_only.csv`
- 37组来源审计中文表：
  `results/tables/cell_type_kla_vs_reference_ddr_statistics_accession_only_zh.csv`
- 33组严格配对英文表：
...
- 纳入和排除审计：
  `results/tables/cell_type_kla_vs_reference_ddr_accession_only_audit.csv`
- Kla 蛋白 ID 明细：
  `work/intermediate/expanded_ddr_by_accession/kla_proteins_by_sample_group.csv`
- 常规蛋白组 ID 与映射明细：
  `work/intermediate/expanded_ddr_by_accession/reference_proteins_by_sample_group.csv`
- 四分类 Venn 样本范围审计：
  `results/tables/four_class_venn/venn_sample_group_scope.csv`
- 四分类 Venn 集合、区域和 membership 表：
  `results/tables/four_class_venn/`
- 四套 33 组中文 Venn：
  `results/figures/four_class_venn/*_33groups_zh.png`
- 四套 33 组英文 Venn：
  `results/figures/four_class_venn/*_33groups_en.png`

## 运行命令

```bash
Rscript R/build_ensembl_uniprot_mapping.R .
Rscript R/analyze_expanded_ddr_fraction_by_accession.R .
Rscript R/plot_four_class_area_proportional_venn.R .
Rscript tests/test_expanded_ddr_fraction_by_accession.R .
Rscript tests/test_four_class_area_proportional_venn.R .
```
