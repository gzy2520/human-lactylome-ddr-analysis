...
四集合 Venn 分析。最终 30 组依次分为正常/非肿瘤组织 9 组、癌症组织 2 组、
正常/非肿瘤细胞 7 组和癌症细胞 12 组。
...
最终 30 组 Kla-DDR 蛋白并集包含 399 个唯一 BaseAccession。分别绘制正常组织、
正常细胞、癌组织、癌细胞以及 399 蛋白全集，共 4+1 张独立线性图。评分表中
...
9/2/7/12、七个排除组未进入最终分析、GeneSymbol 回退数为 0、样本内
