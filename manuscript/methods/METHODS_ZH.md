...
两套热图均按肿瘤组织、非肿瘤组织、癌细胞系、正常细胞系排列，列按
...
最终 30 组 Kla-DDR 蛋白并集包含 399 个唯一 BaseAccession。分别绘制肿瘤组织、
非肿瘤组织、癌细胞系、正常细胞系以及 399 蛋白全集，共 4+1 张独立线性图。评分表中
...
2/9/12/7（按图中顺序）、七个排除组未进入最终分析、GeneSymbol 回退数为 0、样本内
