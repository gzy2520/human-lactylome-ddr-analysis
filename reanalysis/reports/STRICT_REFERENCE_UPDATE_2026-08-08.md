...
- 普通全蛋白 Venn 并集：23261 变为 24566；新增 3398，移除 2093。
- 普通全蛋白 DDR Venn 并集：743 变为 764；新增 36，移除 15。
- 当前普通全蛋白四类集合数依次为 18137、8756、13285、14989。
- 当前普通全蛋白 DDR 四类集合数依次为 646、426、631、616。
