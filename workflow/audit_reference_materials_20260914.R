...
a[SampleGroup=='MCF10A',ReadinessCaveat := 'HIGH: actual parameters.txt Protein FDR=1; peptide FDR=0.01. Current evidence parser has no protein-level FDR gate. Reprocess or replace for harmonized protein-level background.']
