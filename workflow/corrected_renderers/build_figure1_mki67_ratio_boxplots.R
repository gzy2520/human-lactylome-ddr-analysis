...
stop_if("ObservationType" %in% names(values), "MKI67 ratio input lacks ObservationType.")
values <- values[ObservationType == "sample"]
stop_if(nrow(values) > 0L, "MKI67 ratio input has no sample-level observations after filtering.")
