# 10_acceptance_tests_v3.R
# Comprehensive automated acceptance tests for B-R v3.
...
cat("=================================================================\n")
cat("=== B-R v3 Automated Acceptance Test Suite ===\n")
cat("=================================================================\n\n")
...
pf_m0 <- fread(file.path(out_dir, "BRv3_perfold_M0.csv"))
...
res_base <- train_predict_cv_engine_v3(tr_iso, ev_iso, models = c("ME2P", "ME_P"))
res_pert <- train_predict_cv_engine_v3(tr_iso, ev_pert, models = c("ME2P", "ME_P"))
...
mp_iso1 <- calc_isolated_mp_v3(A_iso, V_iso, A_sub_assign)
mp_iso2 <- calc_isolated_mp_v3(A_iso, V_pert, A_sub_assign)
...
mp_iso3 <- calc_isolated_mp_v3(A_hold_pert, V_iso, A_sub_assign)
