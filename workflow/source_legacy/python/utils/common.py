...
def relative_path(path: Path, root: Path) -> str:
    # Preserve the logical repository path when raw data are linked into an
    # isolated worktree. Resolving symlinks first would leak machine-specific
    # absolute paths into provenance tables.
    try:
